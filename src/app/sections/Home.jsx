    ...
    <div className="relative overflow-hidden">
      <div className="lg:my-[12vh] relative z-10 mx-auto max-w-8xl">
        <div className="flex flex-col lg:flex-row items-center justify-center text-center mt-12 md:mt-2009 px-4 md:px-12">
          ...
          >
            <WordPullUp
              className="uppercase text-base font-extrabold tracking-widest text-purple-500"
              words="We are back"
            />
            ...
            <motion.div variants={FADE_UP_ANIMATION_VARIANTS}>
              <div className="mt-6 mb-2 text-teal-100/80">
            ...
            <motion.div variants={FADE_UP_ANIMATION_VARIANTS}>
              <div className="z-0 flex mt-4 items-center justify-center">
