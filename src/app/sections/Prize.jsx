    ...
    return (
      <div className="flex flex-col items-center p-6 cursor-default">
        ...
        <div className="flex flex-col gap-8 w-full items-center">
          {/* Prize Pool */}
          <div className="p-6 text-center bg-gray-800 rounded-xl w-full max-w-lg border border-gray-600 shadow-lg hover:shadow-2xl transform transition-transform duration-300 ease-in-out hover:scale-105 hover:translate-y-1">
          ...
          <div className="flex flex-col md:flex-row gap-4 w-full max-w-6xl">
            <div className="p-6 text-center flex-1 bg-gray-800 rounded-xl w-full border border-gray-600 shadow-lg hover:shadow-2xl transform transition-transform duration-300 ease-in-out hover:scale-105 hover:translate-y-1">
          ...
          <div className="flex flex-col md:flex-row gap-8 max-w-2xl">
            <div className="p-6 text-center flex-1 bg-gray-800 rounded-xl border border-gray-600 shadow-lg hover:shadow-2xl transform transition-transform duration-300 ease-in-out hover:scale-105 hover:translate-y-1">
