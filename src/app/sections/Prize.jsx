...
export default function Prize() {
  return (
    <div className="flex flex-col items-center p-6 cursor-default">
      <h2 className="text-4xl md:text-5xl font-extrabold text-center text-transparent bg-clip-text bg-gradient-to-r from-purple-500 via-pink-500 to-red-500 mb-12">
        Prizes
      </h2>
      ...
      <div className="flex flex-col gap-8 w-full items-center">
        ...
        <div className="flex flex-col md:flex-row gap-4 w-full max-w-6xl">
          <div className="p-6 text-center flex-1 bg-gray-800 rounded-xl w-full border border-gray-600 transition-transform duration-300 ease-in-out hover:scale-105">
            ...
            <p className="text-5xl font-bold text-pink-400 w-full">
              ₹ 75,000
            </p>
          </div>

          <div className="p-6 text-center flex-1 bg-gray-800 rounded-xl w-full border border-gray-600 transition-transform duration-300 ease-in-out hover:scale-105">
            <h3 className="text-xl mb-2 text-green-400">
              * 2nd Prize *
            </h3>
            <p className="text-5xl font-bold text-green-400 w-full">
              ₹ 50,000
            </p>
          </div>
