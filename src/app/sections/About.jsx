...
export default function About() {
  ...
  return (
    ...
    >
      <div className="relative h-auto w-full rounded-2xl max-w-4xl p-8 z-20 mt-12 border-dashed bg-sky-950/20 border-2 border-sky-950/40 backdrop-blur-sm">
        <h3
          className={
            "text-4xl font-semibold mb-6 text-center bg-gradient-to-t bg-clip-text leading-none text-transparent from-sky-200 to-sky-800/90"
          }
        >
          What is HackZ’24?
        </h3>
        <p className="tracking-wider text-teal-100/80 leading-8 text-justify text-xl">
